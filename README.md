...
# Edit - Hello from 2026
This is a homebrewed poll-based logging solution built entirely with bash scripts. It was intended for rapid deployment during the NCAE 2025 Competition. Then, on game day, they gave us access to a SIEM. So we didn't really end up using it.
